...
def get_eval_pool(eval_mode, model, model_eval):
    if eval_mode == 'M': # multiple architectures
        ...
        model_eval_pool = [ 'ConvNetD3', 'ConvNetD4', 'ConvNetD5']
    elif eval_mode == '3': # ablation study on network depth
        model_eval_pool = [ 'ConvNetD3']
    elif eval_mode == '4': # ablation study on network depth
        model_eval_pool = [ 'ConvNetD4']
...
def merge(files, output):
    ...
    torch.save(merged_data, os.path.join(load_path, output))

# load_path = './tiny_50'
# images = ['images_best_0.pt', 'images_best_1.pt', 'images_best_2.pt', 'images_best_3.pt', 'images_best_4.pt']
# labels = ['labels_best_0.pt', 'labels_best_1.pt', 'labels_best_2.pt', 'labels_best_3.pt', 'labels_best_4.pt']

# merge(images,'images_best.pt')
# merge(labels,'labels_best.pt')
